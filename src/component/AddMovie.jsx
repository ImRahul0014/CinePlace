                        ...
                        <div class="flex flex-wrap -m-2">
                            <div class="p-2 w-1/2">
                                <div class="relative">
                                    ...
                                    <input type="text" id="name" name="name" value={form.title}
                            ...
                            <div class="p-2 w-full">
                                <div class="relative">
                                    ...
                                    <input id="message" name="message"
                                        ...
                                        class="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"></input>
                                </div>
                            </div>
                            <div class="p-2 w-full">
                                <div class="relative">
                            ...
                            <div class="p-2 w-full">
                                <button onClick={addMovie} class="flex mx-auto text-white bg-violet-700 border-0 py-2 px-8 focus:outline-none hover:bg-green-500 rounded text-lg">{loading ? <TailSpin height={25} /> : 'Submit'}</button>
                            </div>
